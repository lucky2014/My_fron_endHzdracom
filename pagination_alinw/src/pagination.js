  ...
  $.extend(Pagination.prototype, {
    ...
    refreshPaging  : function () {
      ...
      $prev = this.options.redirectUrl
        ? $('<li class="prev" data-index="prev"><a href="' + this.options.redirectUrl + firstPage + '" title="prev" class="kuma-icon kuma-icon-chevron-left"></a></li>').appendTo(this.$wrap)
        : $('<li class="prev" data-index="prev"><a href="' + "javascript:;" + '" title="prev" class="kuma-icon kuma-icon-chevron-left"></a></li>').appendTo(this.$wrap);
