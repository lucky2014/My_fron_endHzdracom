...
- [global.css](https://s.tbcdn.cn/g/platform/common/s/1.1/global/global.css) 用于继承字体文件 (左右切换箭头是字体)
...
<link type="text/css" rel="stylesheet" media="screen" href="https://s.tbcdn.cn/g/platform/common/s/1.1/global/global.css">
...
seajs.use(['pagination','$'], function(Pagination,$) {
	...
	var pageData = new Pagination(tar, {
		...
		type : 'tiny',//使用场景'common'通用的大分页； 'table'在表格中使用的分页；
		size : _size,
